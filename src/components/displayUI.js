    ...
    render(){
        return(
            <div className="display-container">
                ...
                <DisplaySwitchSound volume={this.props.volume} changeVolume={this.props.changeVolume} changeSound={this.props.changeSound} soundBoard1={this.props.soundBoard1} />
            </div>
        )
    }
}
